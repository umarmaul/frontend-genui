...
import { Calories, CaloriesLoading } from "@/components/prebuilt/calories";
import { Menu, MenuLoading, MenuProps } from "@/components/prebuilt/menu";

const API_URL = "http://localhost:7800/chat";
...
const TOOL_COMPONENT_MAP: ToolComponentMap = {
    ...
    "menu-recommendation": {
        ...
        final: (props?: any) => {
            return (
                <div className="flex flex-col space-y-4 lg:flex-row lg:space-y-0 lg:space-x-6 w-full max-w-fit mr-auto">
